...
<p align="center">
  <h1 align="center">🔍 明鉴 · LuminFlow</h1>
...
明鉴（LuminFlow）是一个面向审计领域的 AI 驱动透明协作平台，基于内控审计框架构建。平台覆盖审计全流程——从目标设定、风险评估、智能抽样到影响模拟与报告生成，通过 AI 引擎和交互式可视化，将复杂的审计工作流转化为直观、可协作的数字化体验。
